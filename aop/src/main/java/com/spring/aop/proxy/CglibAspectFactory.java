...
public class CglibAspectFactory implements CglibFactory{
	...
	public CglibAspectFactory() {
		try {
			setCglibInterceptor(Class.forName(
					"com.spring.aop.cglib.CglibAspectInterceptor").newInstance());
		} catch (Exception e) {
			System.err.println("the spring has not found com.spring.aop.cglib.CglibAspectInterceptor");
		}
	}
